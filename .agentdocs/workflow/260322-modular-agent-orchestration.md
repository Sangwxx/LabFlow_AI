...
- ??? / ????????????
  - ????????????????????
  - ?? `update_graph`?`visited`?`path` ??? helper ????????
  - ??????????????????????????
- ?????????????
  - ?????? 2 ?????????? 1400 ???????? LLM
  - ?????? Markdown ?????????????
...
- ?????????????????? PDF ???????????? `PaperSection.order` ?????????????? `block_orders[0]`?
- ?????????????????? `order` ???????? `page_number + order + block_orders + title` ??????????????????????????????
...
## 2026-03-26 ??????
- ????????????????????????`st.file_uploader` ?????????????????????? `landing_pdf_bytes / landing_pdf_name`??????????????????????
- ??????????? `page_number + order + block_orders + title`?PDF ???????? `block_orders[0]`????????????????????????????????????
- `resolve_pdf_source()` ? `resolve_git_repo_path()` ????????????/????? landing ????????? sidebar ?????????????????????
- ???????? LLM ???????????????????????????????????????? Markdown ????????????
- ????????????landing/sidebar ???????????????????????????????????????????
