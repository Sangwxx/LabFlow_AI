...
<style>
    ...
    .quick-guide-shell { margin-top: 0.95rem; padding: 1rem 1.05rem; border-radius: 18px; background: rgba(247, 243, 236, 0.96); border: 1px solid rgba(189, 174, 153, 0.32); }
    .quick-guide-kicker { color: #8b755d; font-size: 0.8rem; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase; margin-bottom: 0.35rem; }
    .quick-guide-headline { color: #1b3042; font-size: 1.02rem; line-height: 1.65; font-weight: 700; margin-bottom: 0.8rem; }
    .quick-guide-grid { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 0.7rem; }
